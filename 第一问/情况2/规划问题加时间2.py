...
# # ------------------写入到平均文件中txt------------------------
# # 文件名可以根据需要调整
# output_file = 'Int_Program_evaluation_results2.txt'
#
# # 打开文件进行写入操作
...
# -----------------------------输出模型评价部分------------------------------
# 文件名可以根据需要调整
output_file = 'linear_model_evaluation_results2.txt'
...
# with pd.ExcelWriter("Crop_Allocation_Results2.xlsx", engine='openpyxl') as writer:
#     # 遍历每一年
#     for year in years:
